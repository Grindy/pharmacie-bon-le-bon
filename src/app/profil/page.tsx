      ...
      <main className="max-w-6xl mx-auto px-4 pt-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <h2 className="text-2xl font-bold text-green-700 [.colorblind_&]:text-blue-800 mb-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            ...
            <div className="border-b border-gray-100 pb-4 mb-4 flex justify-between items-start">
              ...
              <div className="flex space-x-3 text-sm">
                <button className="flex items-center text-gray-600 hover:text-green-700 [.colorblind_&]:hover:text-blue-800 transition-colors">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <h2 className="text-2xl font-bold text-green-700 [.colorblind_&]:text-blue-800 mb-6">
              Historique de Commandes Récents
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              {/* Carte Commande 1 */}
              <div className="bg-green-50 [.colorblind_&]:bg-blue-50 border border-green-200 [.colorblind_&]:border-blue-200 rounded-lg p-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="font-bold text-green-800 [.colorblind_&]:text-blue-900">Commande #cmd1</span>
                  <span className="bg-green-200 [.colorblind_&]:bg-blue-200 text-green-800 [.colorblind_&]:text-blue-900 text-xs font-bold px-2 py-1 rounded-full">
                    Livrée
                  </span>
                </div>
            ...
            <button className="text-green-700 [.colorblind_&]:text-blue-700 font-semibold hover:underline w-full text-center mt-2">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`w-12 h-6 rounded-full transition-colors relative focus:outline-none ${
                    isMarketingSubscribed ? "bg-green-700 [.colorblind_&]:bg-blue-800" : "bg-gray-300"
                  }`}
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`w-12 h-6 rounded-full transition-colors relative focus:outline-none ${
                    isSmsSubscribed ? "bg-green-700 [.colorblind_&]:bg-blue-800" : "bg-gray-300"
                  }`}
                >
