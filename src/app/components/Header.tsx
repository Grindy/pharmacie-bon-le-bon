  ...
  return (
    <header className={`shadow-md transition-colors duration-300 text-white ${colorblind ? "bg-blue-800" : "bg-green-700"}`}>
      <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* CENTER — Menu desktop */}
        <ul className="flex items-center gap-6 text-sm font-bold whitespace-nowrap flex-shrink min-w-0">
          <li className="catalogue:block hidden">
            <Link href="/catalogue" className="flex flex-col items-center hover:opacity-80 transition">
              <svg className="w-9 h-9 mb-1 fill-current" viewBox="0 0 640 640">
          ...
          <li className="circulaire:block hidden">
            <Link href="/circulaire" className="flex flex-col items-center hover:opacity-80 transition">
              <svg className="w-9 h-9 mb-1 fill-current" viewBox="0 0 640 640">
          ...
          <li className="ressources:block hidden">
            <Link href="/ressources" className="flex flex-col items-center hover:opacity-80 transition">
              <svg className="w-9 h-9 mb-1 fill-current" viewBox="0 0 640 640">
              ...
              <span>RESSOURCES SANTÉ</span>
            </Link>
          </li>

          <li className="panier:block hidden">
            <Link href="/panier" className="flex flex-col items-center hover:opacity-80 transition">
              <svg className="w-9 h-9 mb-1 fill-current" viewBox="0 0 640 640">
          ...
          <li className="dossier:block hidden">
            <Link href="/mon-dossier" className="flex flex-col items-center hover:opacity-80 transition">
              <svg className="w-9 h-9 mb-1 fill-current" viewBox="0 0 640 640">
          ...
          <li className="contact:block hidden">
            <Link href="/contact" className="flex flex-col items-center hover:opacity-80 transition">
              <svg className="w-9 h-9 mb-1 fill-current" viewBox="0 0 640 640">
